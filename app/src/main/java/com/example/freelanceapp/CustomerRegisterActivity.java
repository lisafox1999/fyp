...
public class CustomerRegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //show hide password
        ImageView imageViewShowHidePwd = findViewById(R.id.imageView_show_hide_password3);
    ...
    private void createUser(){
        ...
        if (TextUtils.isEmpty(email)){
            ...
            Toast.makeText(CustomerRegisterActivity.this, "Please re-enter your email", Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(CustomerRegisterActivity.this, "Password should be over 6 digits", Toast.LENGTH_LONG).show();
            ...
            mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()){
                        ...
                        Intent intent = new Intent(CustomerRegisterActivity.this, CustomerCreateProfileActivity.class);
